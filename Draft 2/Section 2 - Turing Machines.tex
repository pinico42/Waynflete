...
\medskip\noindent\begin{tabu} to \textwidth{XXXX}
    ...
    $\mathbb{\mathbf{b}def}_1$(\textit{p},\textfrak{C})   & - & R P\textit{p} L & \textfrak{C} \\
    \hhline{====}
...
This taks two pointers, \textit{r} and \textit{w} as arguments which point to the boolean to be read and the boolean to be written
