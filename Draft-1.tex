...
\end{gather*}
    ...
    Church also defines boolean logic and operations used for them:
...
\end{aligned}
\end{equation*}
Note that for these functions which each takes two arguments, \textbf{T} outputs the first while \textbf{F} outputs the second. 
\end{document}
